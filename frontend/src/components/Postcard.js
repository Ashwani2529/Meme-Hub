      ...
      <div id="instaPostCard">
        ...
        <div className="post-image1">
          <img
            id="postImage"
            alt=""
            src="https://plus.unsplash.com/premium_photo-1688431299086-bf835ca28a9d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwzOXx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
          />
        </div>
      ...
      <div id="instaPostCard">
        ...
        >
          <div className="column is-1 pr-0" style={{ width: "55px" }}>
            <img
              id="profilePicture"
              alt=""
              src="https://images.unsplash.com/photo-1594167154836-838be958f605?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwyMnx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
            />
          </div>
          <div className="column is-8 pl-0" style={{ marginTop: "-54px" }}>
            <span className="label username-text mb-0">
        ...
        <div className="post-image1">
          <img
            id="postImage"
            alt=""
            src="https://images.unsplash.com/photo-1689625294577-6f0c8fc49dcf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwyNXx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
          />
        </div>
        <div className="tag-icon is-hidden" id="tagIconArea">
          <span className="material-icons has-text-white">
